...
// 6 Failed get requests + 10 Successful
*/
// POST Requests :
request.post({url: 'http://localhost:4000/api',body: JSON.stringify({arg:'Newton'})}, callback);
request.post({url: 'http://localhost:4000/api',body: JSON.stringify({arg:'Goodall'})}, callback);
request.post({url: 'http://localhost:4000/api',body: JSON.stringify({arg:'Newtton'})}, callback);
...
// 6 Failed post requests + 4 Successful
