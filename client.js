...
request.post({url: 'http://localhost:4000/api',body: JSON.stringify({arg:1164675788980913.0})}, callback);
request.post({url: 'http://localhost:4000/api',body: JSON.stringify({arg:12, arg2:13, arg3:[102]})}, callback);
